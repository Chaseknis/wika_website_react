...
// Mobile Landing Function (moved up to fix no-use-before-define error)
...
export const boxHover = (e) => {
  ...
  if (window.innerWidth >= 986) {
    tl.to(e.target.querySelector('.link'), {
      duration: 0,
      opacity: 1,
